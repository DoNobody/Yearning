...
BEGIN;
	...
	-- admin password: Admin_qwe123
	INSERT INTO `core_account`(id,`password`,is_superuser, username,first_name,last_name,email, is_staff,is_active,`group`,department,auth_group,from_ldap,date_joined,updatetime) VALUES (1,'pbkdf2_sha256$100000$HzRrq0dpFgPV$O6AX4gaiMMjYl1w8BplPOyYzPrPn2B3aK2FZDeRx7cA=',0, 'admin','admin','admin','', 1, 1, 'admin','dba','admin',0,NOW(), NOW());
COMMIT;
